...
/* The host's running-turn label uses a transparent blue shimmer. In the
   custom dark skin it is a semantic status accent, so keep both the label
   and its elapsed clock gold without changing the original light theme. */
